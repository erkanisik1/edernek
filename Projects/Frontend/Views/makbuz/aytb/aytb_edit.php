            ...
            <table class="table table-bordered table-striped">
                  ...
                  <div class="control-group">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                              <input type="text" name="isim" class="span11 buyuk" placeholder="Adını Yazın" value="<?php echo $kisi->adi; ?>" READONLY>
                  ...
                  <div class="control-group">
                        ...
                        <div class="controls">
                              <input type="text" name="adres"   class="span11 buyuk" value="<?php echo $kisi->yyeri; ?>">
                        </div>
                  </div>
                  ...
                  <div class="control-group">
                        ...
                        <div class="controls">
                              <input type="tel" name="telefon"  class="span11" value="<?php echo $kisi->telefon; ?>">
                        </div>
                  </div>             
...
<hr>
                  ...
                  <?php for ($i=1; $i < 10 ; $i++) { ?>
                      <tr class="odd gradeX">
                              <td >
                                    <input type="text" name="aytb<?php echo $i; ?>[]" class="span12" value="<?php echo $i; ?>" disabled>
                              </td>
                              <td>
